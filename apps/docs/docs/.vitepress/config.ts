...
export default defineConfig({
  ...
  description:
    'huntersofbook open the tools we use in our projects to all developers.',
  editLink: true,
  head: [
    [
      'meta',
  ...
  themeConfig: {
    ...
    editLink: {
      pattern:
        'https://github.com/huntersofbook/huntersofbook/edit/main/apps/docs/:path',
